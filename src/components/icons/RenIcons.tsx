...
import { ReactComponent as StipendChain } from './../../assets/icons/stipend-logo.svg'
...
export const StipdendFullIcon: CustomSvgIconComponent = (props) => {
  const scalingProps = getScalingProps(121, 52)
  return <SvgIcon component={StipendChain} {...scalingProps} {...props} />
}
