                ...
                <div>
                  <Box height={200}>
                    <Box pb={1}>
                      <AssetDropdown
                        defaultValue='WSPD'
                        label='Send' mode={'currency'} available={[]} balances={[]} condensed={false} assetLabel={''} blockchainLabel={''}                      />
                    </Box>
                    <Box pb={1}>
                      <AssetDropdown
                        mode='chain'
                        defaultValue='BTCC'
                        label='Destination Chain' available={[]} balances={[]} condensed={false} assetLabel={''} blockchainLabel={''}                      />
                    </Box>
                    <AssetDropdown
                      condensed
                      mode='chain'
                      ...
                      label='Destination Chain' available={[]} balances={[]} assetLabel={''} blockchainLabel={''}                      
                    />
                  </Box>
                  <Button
                    variant='contained'
              ...
              {tab === TabPhase.RELEASE && (
                <div>
                  <Box height={200}>
                    <AssetDropdown
                      defaultValue='SPD'
                      label='Receive' mode={'currency'} available={[]} balances={[]} condensed={false} assetLabel={''} blockchainLabel={''}                    />
                  </Box>
                  <Button
                    variant='contained'
                    color='primary'
